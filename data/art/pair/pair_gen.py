...
def gen_data(dir_name,n,Z):
    ...
    z=rng.normal(loc=0.0, scale=z_sigma, size=n)
...
if __name__ == '__main__':
    n = 200 # size of each data set
    sets = 20 # number of data sets
    Z_random = np.random.choice([0,1],size=sets,p=[0.5,0.5]) # 0 if no latent confounder Z, 0 if Z exists

    dir_name = 'pair_size'+str(n)+'sigma02poly3'
